    ...
    extends AbstractBuildOrderTCK
{
            ...
            throws Exception
    {
        ...
        /* @formatter:off */
        graph.storeRelationships( new SimpleDependencyRelationship( source, c, new SimpleArtifactRef( b, null, null, false ), null, 0, false, false, false ),
                                  new SimpleDependencyRelationship( source, b, new SimpleArtifactRef( a, null, null, false ), null, 0, false, false, false ) );
        /* @formatter:on */
