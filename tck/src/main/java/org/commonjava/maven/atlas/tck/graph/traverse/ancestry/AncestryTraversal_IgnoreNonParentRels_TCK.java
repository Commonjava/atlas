    ...
    extends AbstractSPI_TCK
{
        ...
        throws Exception
    {
        ...
        graph.storeRelationships( new SimpleParentRelationship( source, myRef, parentRef ),
              new SimpleDependencyRelationship( source, myRef, new SimpleArtifactRef( new SimpleProjectVersionRef( "some.group", "foo", "1.0"   ), null, null, false ), null, 0, false, false, false ),
              new SimpleDependencyRelationship( source, myRef, new SimpleArtifactRef( new SimpleProjectVersionRef( "some.group", "bar", "1.2.1" ), null, null, false ), null, 1, false, false, false ),
