    ...
    extends AbstractSPI_TCK
{
        ...
        throws Exception
    {
        ...
        /* @formatter:off */
        graph.storeRelationships( new SimpleDependencyRelationship( source, project, new SimpleArtifactRef( dep, null, null, false ), null, 0, false, false, false ),
                                         new SimpleDependencyRelationship( source, dep,  new SimpleArtifactRef( dep2,  null, null, false ), null, 0, false, false, false ) );

        final boolean introduces = graph.introducesCycle( new SimpleDependencyRelationship( source, dep,  new SimpleArtifactRef( project,  null, null, false ), null, 0, false, false, false ) );
        /* @formatter:on */
